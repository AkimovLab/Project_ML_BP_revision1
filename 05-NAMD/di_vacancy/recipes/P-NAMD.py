...
from recipes import fssh_nbra, fssh2_nbra, dish_nbra, dish_rev2023_gfsh_nbra, dish_rev2023_nbra, ida_nbra, idf_nbra, ida_gfssh_nbra, msdm_gfsh_nbra, msdm_nbra, mash_nbra

#from matplotlib.mlab import griddata
#%matplotlib inline 
warnings.filterwarnings('ignore')

path_to_save_ci_Hvibs = '/home/98722002/Desktop/WORK-DIRECTORY/ML-BP/PBE0/04-NACs/pristine/res-mb-sd-DFT'
istep = 2000
fstep = 3998
NSTEPS = fstep - istep
#================== Read energies =====================
...
#     x = np.array( np.diag( energy_mat.todense() ) )
#     for i in range1, nstates():
#         x[i,i] += 0.1
...
####################
####################
####################dish dish dish dish#================== Model parameters ====================
...
dyn_general = { "nsteps":NSTEPS, "ntraj":1998, "nstates":NSTATES, "dt":1.0*units.fs2au,
...
# ################################
nthreads = 32
ICONDS = list(list(range(1,1000,50)))################################
...
####################
####################
####################fssh_nbra fssh_nbra fssh_nbra #================== Model parameters ====================
model_params = { "timestep":0, "icond":0,  "model0":0, "nstates":NSTATES }
