...
params['lowest_orbital'] = 155-30
params['highest_orbital'] = 156+30
...
if params['cube_visualization']:
    ...
    params['states_to_plot'] = list(range(154,158))#list(range(380,383))
    params['plot_phase_corrected'] = True #True
    params['vmd_exe'] = 'vmd'
    params['tachyon_exe'] = '/opt/vmd/lib/tachyon_LINUXAMD64'
    params['x_pixels'] = 2048
    params['y_pixels'] = 2048
...
# CP2K executable 
params['cp2k_exe'] = '/home/98722002/cp2k-v7/cp2k/exe/local/cp2k.popt'
...
params['trajectory_xyz_filename'] = path + '/../MD_divac1-pos-1.xyz'
